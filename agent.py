...
class DPG():
    ...
    def learn(self):
        ...
        states,actions,rewards,next_states,dones,weights, indices = self.memory.sample(self.batch_size, beta=self.beta)
        ...
        q_discounted_next = gamma*q_next_action_target
